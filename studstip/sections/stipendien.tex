...
\begin{center}
	...
	\begin{tabularx}{\textwidth}{ @{} l @{}p{\dist}@{} X @{}}
		\tym{2020}{09} - \tym{2020}{11}
			&& \job{BESUD-Stipendium} \hfill \coy{LMU München}{DE} \\[-1em]
			&& \smaller{1}{\normalfont Für besonders engagierte Studierende und Doktoranden} \\
		\tym{2015}{01} - \tym{2016}{12}
			&& \job{German Language Elective Scholarship} \hfill \coy{Ministry of Education}{SG} \\
		\tym{2011}{01} - \tym{2016}{12}
			&& \href{https://go.yudong.dev/MOE-ESIS}{\job{Edusave Scholarships for Independent Schools (ESIS)}} \\[-1em] 
			&& \smaller{1}{Top 3\% des nationalen Jahrgang} \hfill \coy{Ministry of Education}{SG} \\[-0.7em]
			&& \smaller{2}{Übernahme der Schulgebühren} \ifextended \\[-1em] \else\fi
	\end{tabularx}
\end{center}
