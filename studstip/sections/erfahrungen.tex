...
% 			&& \smaller{2}{Full-Stack Webentwicklung und Automatisierung von Aufgaben} \\
		\else\fi
		...
		\tym{2014}{01} - \tym{2016}{06}
			...
			&& \smaller{2}{\phantom{\texttt{2016}} \hspace{0.5em} {"Measuring Temporal Coherence of Light from a Mercury Vapour Lamp"}} \\
